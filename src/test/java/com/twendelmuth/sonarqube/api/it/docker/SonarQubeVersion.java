...
public enum SonarQubeVersion {
	...
	public static List<SonarQubeVersion> getSonarQubeVersionsWithLicense(SonarQubeLicense license) {
		return getSonarQubeVersionsWithLicense(Arrays.asList(SonarQubeVersion.values()), license);
	}

	public static List<SonarQubeVersion> getSonarQubeVersionsWithLicense(Collection<SonarQubeVersion> allowedVersions, SonarQubeLicense license) {
