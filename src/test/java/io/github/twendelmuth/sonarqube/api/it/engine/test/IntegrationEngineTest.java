...
import io.github.twendelmuth.sonarqube.api.it.engine.IntegrationSettings;
...
class IntegrationEngineTest {
	...
	void testIntegrationEngine_selectPackage() {
		EngineTestKit
				.engine("SonarQubeIntegrationTestEngine")
				.selectors(DiscoverySelectors.selectPackage("io.github.twendelmuth.sonarqube.api.it.engine.test"))
				.execute()
				.testEvents()
				.assertStatistics(assertStatistics(2));
	}
